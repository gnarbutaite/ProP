...
/*
function ticketPrice(clickedradio){
    if(clickedradio.checked==true){
        totalPrice+=55;
    }else{
        totalPrice-=55;
    }
    var multiplier=0;
    var singleTicket = clickedradio.parentNode;
    for (var i = 0; i < singleTicket.childNodes.length; i++) {
        ...
        if(singleTicket.childNodes[i].className == "day1" 
                ||singleTicket.childNodes[i].className == "day2" 
                || singleTicket.childNodes[i].className == "day3"){
...
function buyTickets(){
    ...
    for (var i = 0; i < numberOfTickets; i++) {
        var singleTicket = [];
        singleTicket[0] = day1[i].checked;
        singleTicket[1] = day2[i].checked;
        singleTicket[2] = day3[i].checked;

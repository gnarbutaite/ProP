...
<link rel="stylesheet"; type="text/css"; href="Styling.css">
   ...
   function Change()
    ...
    <body class="place"><div id="top">
        ...
        <iframe style="height:100%;width:100%;border:1;" frameborder=1 src="https://www.google.com/maps/embed/v1/place?q=Molecaten+Park+Kuierpad,+Oranjekanaal+Noordzijde,+Wezuperbrug,+Netherlands&key=AIzaSyAN0om9mFmy1QN6Wf54tXAowK4eT0ZUPrU" class="iframe"></iframe>
        ...
        <style>#gmap_canvas img{max-width:none!important;background:none!important;font-size: inherit; border-color:saddlebrown; border-width: 3px;}</style>
        </div>
